## -*- cmake -*-
#===============================================================================
## @file FindRTIConnextDDS.cmake
## @brief Find RTI DDS codegen executable.
## @author Tor Slettnes <tslettnes@picarro.com>
## This file is copied from the RTI DDS v6.1.2 distribution, with minor
## fixes to support cross-compilation to/from Windows.
#===============================================================================
...
if(messaging_api IN_LIST RTIConnextDDS_FIND_COMPONENTS
    ...
    if(MESSAGING_C_API_FOUND AND MESSAGING_CPP_API_FOUND AND
        ...
        message(STATUS "MESSAGING API FOUND")
    else()
        set(RTIConnextDDS_messaging_api_FOUND FALSE)
        message(STATUS "MESSAGING NOT FOUND FOUND")
      endif()
endif()
