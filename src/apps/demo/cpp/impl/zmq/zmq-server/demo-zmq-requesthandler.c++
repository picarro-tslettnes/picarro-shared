...
namespace picarro::demo::zmq
{
    ...
    protobuf::Empty RequestHandler::say_hello(const Picarro::Demo::Greeting &request)
    {
        this->api->say_hello(protobuf::decoded<Greeting>(request));
        return {};
    }

    Picarro::Demo::TimeData RequestHandler::get_current_time(const protobuf::Empty &request)
    {
        return protobuf::encoded<Picarro::Demo::TimeData>(this->api->get_current_time());
    }
