...
from ipc.google.protobuf               import Picarro as _CC, ProtoBuf
...
Weekdays = enums(Picarro.Demo.Weekday)
...
class DemoClient (Client):
    ...
    def __init__(self,
        ...
        self.subscriber = SignalSubscriber(
            ...
            signal_type  = Picarro.Demo.Signal)
    ...
    def say_hello(self, text: str, **kwargs):
        ...
        request = Picarro.Demo.Greeting(text=text,
                                   identity=self.identity,
                                   implementation=type(self).__name__,
                                   birth=Picarro.encodeTimestamp(self.birth),
    ...
    def get_current_time(self) -> Picarro.Demo.TimeData:
        ...
        return self.call('get_current_time', None, Picarro.Demo.TimeData)
    ...
    def start_notify_greetings(self,
                               callback: Callable[[Picarro.Demo.Greeting], None],
                               prepend: tuple = (),
                               append: tuple = (),
                               **kwargs):
        '''
    ...
    def start_notify_time(self,
                          callback: Callable[[Picarro.Demo.TimeData], None],
                          prepend: tuple = (),
                          append: tuple = (),
                          **kwargs):
        '''
