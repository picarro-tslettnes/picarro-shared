...
namespace core::str
{
    ...
    //==========================================================================
    // Partial template specialization for unsigned integer<>string conversion
    // template <>
    // struct StringConvert<std::uint64_t>
    // {
    //     static std::uint64_t from_string(const std::string_view &s);
    //     static std::string to_string(const std::uint64_t &value);
    // };

    //==========================================================================
    // Partial template specialization for floating point<>string conversion
    // template <>
    // struct StringConvert<double>
    // {
    //     static double from_string(const std::string_view &s);
