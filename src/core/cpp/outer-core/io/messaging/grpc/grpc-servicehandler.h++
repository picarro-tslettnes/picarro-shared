...
/// @brief Service-side wrapper functionality for Picarro gRPC services
...
namespace core::grpc
{
    ...
    ///      class YourService : public ServiceHandler<Picarro::yourapp::YourService>
    ///      {
    ///      public:
    ///          YourService (const std::string &interface)
    ///             : ServiceHandler<Picarro::yourapp::YourService>(interface) {}
    ///          ...
    ///      };
    ///    \endcode
    ///
    ...
    ///                                           const Picarro::yourapp::SomeRequest *request,
    ///                                           Picarro::yourapp::SomeResponse *reply)
    ///      {
    ///        try
    ///        {
    ///          handle(request);
