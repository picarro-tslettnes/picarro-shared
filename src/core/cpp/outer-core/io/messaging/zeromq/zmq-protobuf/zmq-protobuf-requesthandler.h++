...
namespace core::zmq
{
    ...
    public:
        void process_method_request(const Picarro::RR::Request &request,
    ...
    protected:
                         ...
                         ReplyType (Subclass::*method)(const RequestType &))
        {
            this->handler_map.insert_or_assign(
                method_name,
                [=](const Picarro::RR::Parameter &req_param, Picarro::RR::Parameter *rep_param) {
                    RequestType req;
    ...
    private:
        ...
        using MethodHandler =
            std::function<void(const Picarro::RR::Parameter &request,
                               Picarro::RR::Parameter *reply)>;
