...
from ..core  import API, Picarro, ProtoBuf, SignalSlot, demo_signals
from picarro.messaging.zmq.basic import Subscriber
from picarro.messaging.zmq.protobuf import Client, SignalHandler
...
class DemoClient (API, Client):
    ...
    def say_hello(self, greeting: Picarro.Demo.Greeting):
        self.check_type(greeting, Picarro.Demo.Greeting)
