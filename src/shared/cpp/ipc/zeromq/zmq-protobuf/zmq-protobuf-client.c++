...
namespace picarro::zmq
{
    ...
    void ProtoBufClient::send_request(const Picarro::RR::Request &request,
    ...
    bool ProtoBufClient::receive_reply(Picarro::RR::Reply *reply,
    ...
    bool ProtoBufClient::send_receive(const Picarro::RR::Request &request,
    ...
    bool ProtoBufClient::read_result(Picarro::RR::Parameter *param,
                                     ...
                                     ::zmq::recv_flags flags)
    {
        ...
        if (this->read_result(param, &status, flags))
        {
            switch (status.code())
            {
            case Picarro::RR::STATUS_OK:
            case Picarro::RR::STATUS_ACCEPTED:
                break;
    ...
    void ProtoBufClient::send_protobuf_invocation(const std::string method_name,
                                                  ...
                                                  ::zmq::send_flags send_flags)
    {
        Picarro::RR::Parameter request_param;
