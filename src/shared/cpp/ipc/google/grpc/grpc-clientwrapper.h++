...
namespace picarro::grpc
{
    ...
    public:
        ...
        ///
        /// @throw picarro::grpc::ServiceError
    ...
    ///      class YourClient : [...,] public ClientWrapper<Picarro::yourapp::YourService>
    ///      {
    ///      public:
    ///          YourClient (const std::string &identity,
    ///                      const std::string &serverAddress)
    ///              : ...,
    ///                ClientWrapper<Picarro::yourapp::YourService>(serverAddress),
    ///                ...
    ///              {}
    ///      }
    ///    ```
    ...
    ///          Picarro::yourapp::SomeRequest request = ...;
