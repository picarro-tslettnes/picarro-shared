...
/// @brief Server-side wrapper functionality for Picarro gRPC services
...
namespace picarro::grpc
{
    ...
    ///      class YourService : public ServerWrapper<Picarro::yourapp::YourService>
    ///      {
    ///      public:
    ///          YourService (const std::string &interface)
    ///             : ServerWrapper<Picarro::yourapp::YourService>(interface) {}
    ///          ...
    ///      };
    ///    \endcode
    ///
