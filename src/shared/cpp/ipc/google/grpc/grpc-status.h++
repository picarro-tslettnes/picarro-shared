...
namespace picarro::grpc
{
    ...
    public:
        ...
        /// @param[in] details
        ///     Already-constructed Picarro::Status::Details ProtoBuf container
        Status(const Picarro::Status::Details &details);
        ...
        /// @return
        ///     Details as a Picarro::Status::Details instance.
        Picarro::Status::Details details() const noexcept;
