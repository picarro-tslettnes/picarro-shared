...
namespace picarro::argparse
{
    ...
    void CommonOptions::add_options()
    {
        ...
        this->add_opt(
            ...
            "DDS Domain",
            &this->domain_id,
            picarro::settings->get("dds domain id", 0).as_uint());
    }
    ...
    void CommonOptions::add_log_options()
    {
        ...
        this->add_flag(
            ...
            &this->log_colors,
            picarro::settings->get("log colors", true).as_bool());
#endif
        ...
        this->add_flag(
            ...
            &this->log_context,
            picarro::settings->get("log context", false).as_bool());
    ...
    {
        types::KeyValueMap thresholds = picarro::settings->get("log thresholds").as_kvmap();
    ...
    {
        return picarro::settings->get(sink_name).as_kvmap();
    }
