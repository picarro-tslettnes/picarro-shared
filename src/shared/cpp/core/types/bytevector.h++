...
{
    template <>
    struct hash<picarro::types::ByteVector>
    {
        inline std::size_t operator()(const picarro::types::ByteVector &b) const
        {
...
using Byte = picarro::types::Byte;
using ByteVector = picarro::types::ByteVector;
