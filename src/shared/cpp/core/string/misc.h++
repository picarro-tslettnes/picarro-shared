...
namespace picarro::str
{
    ...
    void toupper(std::string *s, const std::locale &loc = std::locale());
    ...
    void tolower(std::string *s, const std::locale &loc = std::locale());
    ...
    std::string toupper(const std::string &s, const std::locale &loc = std::locale());
    ...
    std::string tolower(const std::string &s, const std::locale &loc = std::locale());
    ...
    std::string from_wstring(const wchar_t *begin, std::size_t size);
    ...
    std::wstring to_wstring(const char *begin, std::size_t size);
    ...
    template <class... Args>
    std::string to_string(const Args &...args) noexcept
    {
        std::stringstream ss;
        (ss << ... << args);
        return ss.str();
    ...
    template <typename T>
    inline std::string hex(T val, size_t width = sizeof(T) * 2, std::string prefix = "0x")
    {
        std::stringstream os;
