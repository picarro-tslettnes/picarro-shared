...
namespace std
{
    ...
    {
        picarro::str::format(stream, "{%r, %r}", pair.first, pair.second);
        return stream;
    }
                                    ...
                                    const std::vector<T> &vector)
    {
        ...
        {
            picarro::str::format(stream, "%s%r", sep, element);
            sep = ", ";
        }
        stream << "}";
        return stream;
                                    ...
                                    const std::map<K, V> &map)
    {
        ...
        {
            picarro::str::format(stream, "%s%r: %r", sep, kv.first, kv.second);
            sep = ", ";
        }
        stream << "}";
        return stream;
                                    ...
                                    const std::set<V> &set)
    {
        ...
        {
            picarro::str::format(stream, "%s%r", sep, v);
            sep = ", ";
        }
        stream << "}";
        return stream;
                                    ...
                                    const std::optional<V> &opt)
    {
        if (opt.has_value())
        {
            picarro::str::format(stream, "%r", opt.value());
        }
        else
        {
            stream << "{}";
                                    ...
                                    const std::shared_ptr<V> &ptr)
    {
        if (ptr)
        {
            picarro::str::format(stream, "{%r}", *ptr);
        }
        else
        {
            stream << "{}";
                                    ...
                                    const std::weak_ptr<V> &weakptr)
    {
        ...
        {
            picarro::str::format(stream, "{%r}", *sptr);
        }
        else
        {
            stream << "{}";
